...
-- Converted from MySQL 8 (utf8mb4_0900_ai_ci → utf8mb4_unicode_ci)
...
CREATE DATABASE IF NOT EXISTS bci_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `users_erp` (
...
CREATE TABLE IF NOT EXISTS `user_product_types` (
  `user_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`user_id`,`category_id`),
  CONSTRAINT `user_product_types_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users_erp` (`user_id`) ON DELETE CASCADE,
